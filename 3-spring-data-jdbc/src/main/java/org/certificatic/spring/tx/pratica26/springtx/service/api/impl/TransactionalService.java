...
public class TransactionalService implements ITransactionalService {
	...
	public BusinessObject getBusinessObject(Long id) {
		log.info("{}", colorWriter.getColoredMessage(Color.BLUE, "inside getBusinessObject"));
	...
	public void insertBusinessObject(BusinessObject businessObject) {
		log.info("{}", colorWriter.getColoredMessage(Color.BLUE, "inside insertBusinessObject"));
	...
	public void deleteBusinessObject(Long id) {
		log.info("{}", colorWriter.getColoredMessage(Color.BLUE, "inside deleteBusinessObject"));
