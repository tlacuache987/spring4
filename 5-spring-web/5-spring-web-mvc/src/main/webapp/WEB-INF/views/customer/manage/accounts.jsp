...
<div id="box">
	<h3>
		<span style="display: inline-block; text-align: left; width: 49%;">
			Manage Accounts </span> <span
			style="display: inline-block; text-align: right; width: 50%;">
			<a href="${site_url}customer/manage/accounts/create"> <span
				style="font-size: 12px;">Create New Account</span> <img width="16"
				height="16" src="${site_url}resources/img/icons/user_add.png"
		...
		<thead>
			<tr>
				<th width="40px"><a href="#">ID <img
						src="${site_url}resources/img/icons/arrow_down_mini.gif"
						width="16" height="16" align="middle" /></a></th>
				<th><a href="#">Number</a></th>
				<th><a href="#">Created Date</a></th>
				<th><a href="#">Balance</a></th>
				<th width="100px"><a href="#">Actions</a></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="pager">
		Página <a href="#"><img src="resources/img/icons/arrow_left.gif"
			width="16" height="16" /></a> <input size="1" value="1" type="text"
			name="page" id="page" /> <a href="#"><img
			src="resources/img/icons/arrow_right.gif" width="16" height="16" /></a>de
		50 páginas | Viendo <select name="view">
			<option>10</option>
			<option>20</option>
			<option>50</option>
			<option>100</option>
		</select> registros por página | Total <strong>420</strong> registros
		encontrados.
	</div>
</div>
<br />