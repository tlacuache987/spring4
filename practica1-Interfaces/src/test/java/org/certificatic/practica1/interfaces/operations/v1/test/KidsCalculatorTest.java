...
import org.certificatic.practica1.interfaces.operations.v1.api.impl.KidsCalculator;
...
public class KidsCalculatorTest {
	...
	public void kidsCalculatorTest() {
		...
		((KidsCalculator) kidsCal).set(5);
		((KidsCalculator) kidsCal).add(5);
		((KidsCalculator) kidsCal).add(5);
		((KidsCalculator) kidsCal).add(-5);
		((KidsCalculator) kidsCal).subtract(4);
		
		((KidsCalculator) kidsCal2).set(-5);
		((KidsCalculator) kidsCal2).add(5).add(5).subtract(4).add(5);
