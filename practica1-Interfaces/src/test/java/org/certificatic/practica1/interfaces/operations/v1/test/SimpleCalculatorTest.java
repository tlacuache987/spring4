package org.certificatic.practica1.interfaces.operations.v1.test;

import java.text.DecimalFormat;

import org.certificatic.practica1.interfaces.operations.v1.api.ICalculator;
import org.certificatic.practica1.interfaces.operations.v1.api.impl.SimpleCalculator;
...
public class SimpleCalculatorTest {
	...
	public void kidsCalculatorTest() {
		...
		((SimpleCalculator) simpleCal).set(5);
		((SimpleCalculator) simpleCal).add(5).add(5).add(-5).subtract(4).multiply(8).divide(2);
		
		((SimpleCalculator) simpleCal2).set(-5);
		((SimpleCalculator) simpleCal2).add(5).add(5).subtract(4).add(5).divide(2).multiply(8);
