...
public class AccountService implements IAccountService {
	...
	public void updateAccountBalance(Account account, Long amount) {
		log.info("Inside accountService.updateAccountBalance(). Account: {}, ammount: {}", account.getAccountNumber(),
				amount);
	...
	public List<Account> findCustomerAccounts(Long customerId) {
		log.info("Inside accountService.findCustomerAccounts(). Finding accounts for customer: {}", customerId);
	...
	public void updateAccountDescription(Account account) {
		log.info("Inside accountService.updateAccountDescription(). Updating account [{}] description to: {}",
