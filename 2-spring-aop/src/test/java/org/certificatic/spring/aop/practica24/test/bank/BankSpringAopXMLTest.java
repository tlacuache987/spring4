...
@ContextConfiguration(locations = "classpath:/spring/practica24/bank-aop-xml-application-context.xml")
public class BankSpringAopXMLTest {
	...
	public void bankSpringAopXMLTest1() {
		...
		Account account = Account.builder().accountNumber("123123").accountDescription("My favourite account").build();
